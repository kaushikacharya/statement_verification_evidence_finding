...
class Dataset:
    ...
    def process_data_dir(self, data_dir):
        ...
        for xml_file_path in glob.iglob(os.path.join(data_dir, "*.xml")):
            ...
            doc_obj = Document()
            failed_tables_doc, n_tables_doc, n_statements_doc = doc_obj.parse_xml(xml_file=xml_file_path, verbose=False)
        ...
        print("Processed {} files :: tables: {} :: statements: {}".format(n_files, n_tables_dataset, n_statements_dataset))
